...
from feature.frame_feature import frame_feature
...
if __name__ == "__main__":
    ...
    for filename in filenames:
        ...
        for fps in FPSS:
            frame_feature(working_path, interval, fps, FEATURE_SIZE)
        feature_results_filename = f"{base_name}_Feature_Result.json"
        clip_feature(working_path, feature_results_filename, interval, FPSS, CLASSES)