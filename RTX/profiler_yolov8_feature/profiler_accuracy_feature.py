...
from feature.frame_feature import frame_feature, feature_number_to_type
from feature.clip_feature import clip_feature
...
if __name__ == "__main__":
    ...
    for filename in filenames:
        ...
        # Other Features Across Different FPSs
        for fps in FPSS:
            frame_feature(working_path, interval, fps, CLASSES, FEATURE_NUMBER, FEATURE_SIZE)
        feature_results_filename = f"{base_name}_Feature_{feature_number_to_type(FEATURE_NUMBER)}_Result.json"
        clip_feature(working_path, feature_results_filename, interval, FPSS, FEATURE_NUMBER, CLASSES)